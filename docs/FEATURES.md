...
| Message queue while streaming | Yes | Composer enqueue while busy · FIFO auto-send · chips ×/Clear · Stop keeps queue · `msg_queue` · 1.27.93 |
...
| Mic STT + TTS speak | Yes | 🎤 / 🔊 / Ctrl+M · Settings Voice · engines local/openai/elevenlabs · 1.27.94 |
