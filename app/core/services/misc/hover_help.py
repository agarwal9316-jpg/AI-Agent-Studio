...
CHAT_CONTROLS: dict[str, dict[str, str]] = {
    ...
    "mic": {"label": "🎤 Mic", "help": "Speak instead of typing (Settings → Voice STT engine: local or OpenAI Whisper)."},
    "speak": {"label": "🔊 Speak", "help": "Read the last assistant reply aloud (Settings → Voice TTS: local / OpenAI / ElevenLabs)."},
