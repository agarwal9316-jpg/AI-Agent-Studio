...
PAGE_TIPS: dict[str, str] = {
    ...
    "Plugins": "Add MCP servers or paste an OpenAPI URL; Test discovers tools for chat.",
    "Notes": "Write notes and attach them to chat.",
    "Channels": "Shared timeline with @model asks.",
    "Automations": "Schedule prompts that open a linked chat.",
